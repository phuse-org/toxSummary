...
generate multiple summary table for all the studies.  Summary table also highly
customizable and can be downloaded in different format. 
...
On the landing page (Program tab) there is a button  
...
program number 155582 (last 3 rows). 
Make sure first column contain program number and second column contain study ID number.

## Plot   
When user create an program and add study information, app will create plot
and plot will be shown on program tab. Plot can be think of as two
...
be downloaded as csv, Excel and microsoft word file. User also can download all the plot as image (jpeg file). 
